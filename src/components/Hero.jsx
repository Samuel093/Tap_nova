...
const Hero = () => {
  return (
    ...
    >
      <div className="min-h-screen flex flex-col items-center justify-center px-4 py-14 md:px-8 md:py-24 lg:py-32 text-center">
        <motion.div
        ...
        <div className="w-full overflow-x-hidden mt-10 mb-0">
